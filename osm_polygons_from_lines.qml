...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="boundary" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="national_park" label="National Park"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Size" value="1~~1~~CASE &#xd;&#xa;WHEN $scale> 3500000 THEN 0&#xd;&#xa;WHEN $scale >= 1500000 THEN 7&#xd;&#xa;WHEN $scale >= 1000000 and $scale &lt; 1500000 THEN 8&#xd;&#xa;WHEN $scale >= 500000 and $scale &lt; 1000000 THEN 9&#xd;&#xa;WHEN $scale >= 100000 and $scale &lt; 500000 THEN 10&#xd;&#xa;ELSE 10&#xd;&#xa;END~~"/>
    ...
    <property key="labeling/textColorB" value="99"/>
    <property key="labeling/textColorG" value="99"/>
  ...
  <aliases>
    ...
    <alias field="boundary" index="2" name=""/>
  </aliases>
